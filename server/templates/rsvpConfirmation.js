// server/templates/rsvpConfirmation.js
// E-09 — sent when a user's RSVP status is 'going'.
...
function rsvpConfirmation(event, userName) {
...
module.exports = { rsvpConfirmation };
