// server/templates/eventEditConfirmation.js
// E-05 — sent to the organizer when they edit their event.
...
function eventEditConfirmation(event, userName) {
        ...
        <table width='600' cellpadding='0' cellspacing='0'
          ...
          <tr><td style='padding:32px;'>
            ...
            <p style='margin:0 0 24px;font-size:15px;color:#444;'>
              Your event has been updated. Here are the current details:</p>
            <table width='100%' cellpadding='0' cellspacing='0'
                   style='background:#f0f5fb;border-radius:6px;
                          border:1px solid #d0dff0;margin-bottom:24px;'>
              <tr><td style='padding:24px;'>
                <p style='margin:0 0 12px;font-size:20px;font-weight:bold;color:#2E5F8A;'>
                  ${title}</p>
                <table cellpadding='6' cellspacing='0'>
                  ...
                  <tr>
                    <td style='font-size:13px;color:#888;font-weight:bold;'>CATEGORY</td>
            ...
            <p style='margin:0;font-size:13px;color:#888;'>
              Attendees will be notified separately about any changes.</p>
          </td></tr>
          <tr>
...
module.exports = { eventEditConfirmation };